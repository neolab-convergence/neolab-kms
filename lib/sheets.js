...
const SHEET_HEADERS = {
    ...
    posts: ['id', 'boardId', 'categoryId', 'title', 'type', 'icon', 'subInfo', 'content', 'url', 'fileName', 'views', 'date', 'order', 'thumbnail', 'bgColor', 'detailImage', 'detailImageLinks', 'ocrText'],
    notices: ['id', 'title', 'type', 'content', 'date'],
    contacts: ['id', 'name', 'position', 'dept', 'phone', 'mobile', 'email', 'status'],
    orgchart: ['id', 'name', 'title', 'department', 'level', 'parentId', 'order', 'x', 'y', 'color'],
    settings: ['key', 'value'],
    admins: ['email', 'name', 'passwordHash', 'addedBy', 'addedDate'],
    suggestions: ['id', 'content', 'date', 'status', 'adminNote', 'completedBy', 'completedDate'],
...
// 인메모리 캐시 (시트 호환)
// SQLite 읽기는 μs 단위라 길게 캐시할 필요 없음. 짧게 잡아 invalidate 누락/레이스 시 자동 회복.
const cache = {};
